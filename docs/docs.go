// Package docs Code generated by swaggo/swag at 2025-05-11 13:24:31.2805878 +0700 +07 m=+50.336368301. DO NOT EDIT
package docs
...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/class_request.ModifyClassMemberRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Create Member class response",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.BaseResponse"
        ...
        "/academic/class/member/{id}/delete": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "Delete Member class response",
                        "schema": {
                            "$ref": "#/definitions/response.BaseResponse"
                        }
                    }
        ...
        "/academic/class/{classId}/member": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Member class response",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.BaseResponse"
    ...
    "definitions": {
        ...
        "class_request.ModifyClassMemberRequest": {
            "type": "object",
            "properties": {
                "class_id": {
                    "type": "integer"
        ...
        "exam_response.ExamDetailResponse": {
            ...
            "properties": {
                ...
                "modified_by": {
                    "description": "CreatedUser  user.User ` + "`" + `json:\"detail_user\" gorm:\"foreignKey:CreatedBy\"` + "`" + `",
                    "type": "integer"
                },
                "name": {
                    "type": "string"
        ...
        "exam_response.ExamDetailSessionResponse": {
            ...
            "properties": {
                ...
                "exam_member": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/school.ExamSessionMember"
                    }
                },
                "id": {
                    "type": "integer"
        ...
        "teacher.Teacher": {
            ...
            "properties": {
                ...
                "teacherClassSubject": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/teacher.TeacherClassSubject"
                    }
                },
                "updatedAt": {
                    "type": "string"
